...
const SearchSection = () => {
  ...
  const [furnishing, setFurnishing] = useState("Any type");
  const [type, setType] = useState("Any type");

  const typeOptions = {
    Rooms: ["Single Room", "Shared Room", "1 RK"],
    PGs: ["Single PG", "Double Sharing PG", "Triple Sharing PG"],
      ...
      >
        ...
        <div className="flex flex-col gap-8 lg:flex-row lg:items-center lg:justify-between">
          <div>
            ...
            <p className="mt-4 text-lg text-gray-500">
              Search verified rooms with real photos, ratings & zero brokerage.
            </p>
          </div>
        ...
        <div className="mt-12 grid grid-cols-1 gap-6 md:grid-cols-2 lg:grid-cols-5">
          ...
          <motion.div whileHover={{ y: -6 }}>
            ...
            <div className="flex h-[74px] items-center gap-4 rounded-2xl border border-orange-200 bg-white px-5 shadow-sm hover:border-orange-400 hover:shadow-lg">
              <MapPin className="text-[#ff6b1a]" size={24} />
          ...
          <motion.div whileHover={{ y: -6 }}>
            ...
            <div className="relative">
              ...
              <select
                ...
                className="h-[74px] w-full appearance-none rounded-2xl border border-orange-200 bg-white pl-14 pr-5 text-lg shadow-sm outline-none hover:border-orange-400 hover:shadow-lg"
              >
                <option>Any type</option>
          ...
          {/* Search Button */}
          <motion.div whileHover={{ y: -6 }} className="flex items-end">
            <motion.button
              whileHover={{
                scale: 1.03,
                boxShadow: "0px 0px 35px rgba(255,107,26,0.45)",
              }}
              whileTap={{ scale: 0.96 }}
